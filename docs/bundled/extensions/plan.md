...
- `exit_plan(title, plan, revises?)` opens the approval menu. Each option carries a muted description, and the dialog subtitle reports current context usage — the fact the compact-or-not decision turns on:
