...
- Gave interactive Background completion messages compact outcome summaries and bounded expanded shell output or structured worker reports. Saved message text remains authoritative without a live registry lookup; ambiguous formats receive a neutral Details view, legacy notifications keep their existing rendering, and model-facing content, delivery and accounting are unchanged.
