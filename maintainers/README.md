...
- [Upstream baseline](upstream.json) - machine-readable record of the reviewed release tag, runtime package versions, and the per-path delta registry
- [Delta](delta.md) - what each difference against the reviewed upstream baseline is for and how to re-verify it
